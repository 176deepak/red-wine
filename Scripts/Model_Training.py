...
def train_test():
    try:
        ...
        y_test = test['quality']
        logging.info({"Success! dataset splitted into training and testing dataset."})
        return (X_train, X_test, y_train, y_test)
    except:
        logging.error("Exiting! Error in train_test function.")
...
def models_report(X_train, X_test, y_train, y_test):
    ...
    try:
        ...
        logging.info("Success! Models Report generated.")
        return (models, accuracy_report, params_report)
    except:
        logging.error("Exiting! Error in models_report function.")
...
def model_trainer(models, accuracy_report, params_report):
    try:
        ...
        logging.error("Exiting! Error in model_trainer function.")
